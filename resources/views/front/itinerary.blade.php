                            ...
                            <div class="tab-pane fade show active" id="day{{$Theitineraries->id}}">
                                <div class="content-box">
                                    @php
                                                ...
                                                $content = $Theitineraries->content;
                                                $content = str_replace('<b>', '<span style="font-weight:bold !important;">', $content);
                            ...
                            <div class="tab-pane fade" id="day{{$Theitineraries->id}}">
                                <div class="content-box">
                                            ...
                                            @php
                                                ...
                                                $content = $Theitineraries->content;
                                                $content = str_replace('<b>', '<span style="font-weight:bold !important;">', $content);
                                                $content = str_replace('<b><i>', '<li style="font-weight:bold !important;">', $content);
                                                $content = str_replace('</i></b>', '</li>', $content);
                                                $content = str_replace('</b>', '</span>', $content);
