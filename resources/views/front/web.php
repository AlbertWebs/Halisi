...
Route::get('/cultures/{slung}', [App\Http\Controllers\CultureController::class,  'cultures']);
Route::get('/trip-impact', [App\Http\Controllers\CultureController::class,  'trip_impact']);

Route::get('/Cultural-Tourism-Uganda', [App\Http\Controllers\CultureController::class,  'Cultural_Tourism_Uganda']);
Route::get('/Cultural-Tourism-Tanzania', [App\Http\Controllers\CultureController::class,  'Cultural_Tourism_Tanzania']);
Route::get('/Cultural-Tourism-Ethiopia', [App\Http\Controllers\CultureController::class,  'Cultural_Tourism_Ethiopia']);
Route::get('/Cultural-Tourism-Botswana', [App\Http\Controllers\CultureController::class,  'Cultural_Tourism_Botswana']);
Route::get('/Cultural-Tourism-Namibia', [App\Http\Controllers\CultureController::class,  'Cultural_Tourism_Namibia']);
Route::get('/Cultural-Tourism-Lesotho', [App\Http\Controllers\CultureController::class,  'Cultural_Tourism_Lesotho']);
