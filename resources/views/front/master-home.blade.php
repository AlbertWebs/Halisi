                ...
                <div class="container-fluid">
                    <div class="primary-menu">
                        ...
                        <div class="site-branding">
                            <a href="{{url('/')}}" class="brand-logo"><img style="max-width:200px" src="{{url('/')}}/uploads/logo/Halisi-Travel-Agency-HOR-15.png" alt="Site Logo"></a>
                        </div>
                        <!--====== Nav Menu ======-->
                        <div class="nav-menu">
                            <!--====== Site Branding ======-->
                            ...
                            <nav class="main-menu">
                                <ul>
                                    ...
                                    <li class="menu-item has-children""><a href="">Cultural Tourism </a>
                                        <ul class="sub-menu">
                                            <li><a href="{{url('/')}}/cultures/{{ __('Kenya') }}">Kenya</a></li>
                                            <li><a href="{{url('/')}}/Cultural-Tourism-Ugandaa">Uganda</a></li>
